...
class Customer(models.Model):
    ...
    customer_contact = models.IntegerField('Customer Contact Number', max_length=30, default=0)

class Catalog(models.Model):
    catalog_dish = models.CharField('Dish Name', max_length=30, default=0)
    catalog_price = models.IntegerField('Dish Price', max_length=30, default=0)
